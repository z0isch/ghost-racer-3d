...
## What one player has bought for one circuit: how many clocks are live on it, how many boost
## ghosts, how many hazard ghosts, how many slipstream ghosts, how many income ghosts. Five raw
## counts rather than levels, all starting at 0 and rising only by being bought (CONTEXT.md's
## **Circuit loadout**).
##
...
## ([method ClockField._resolve_clocks]). income_ghost_count has no meaningful cap at all.
